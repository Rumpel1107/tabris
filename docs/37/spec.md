...
- **AC16** — Dado el arranque del despliegue, cuando el servicio corre por primera vez, entonces crea su propia base vacía en su carpeta de datos y con permisos de solo-dueño; producción no hereda nada de desarrollo y ambas son independientes desde el primer momento. *(Revisado 2026-08-18: la copia inicial de la base de desarrollo se descartó — producción arranca de cero.)*
