MESSAGES = {
    "es": {
        ...
        "no_confirmed_sources":    "No tengo fuentes que pueda confirmar sobre eso. ¿Quieres que lo busque otra vez?",
        "fresh_value_withheld":    "No pude obtener ese dato ahora. Prefiero no darte un valor que puede haber cambiado; ¿lo intento de nuevo?",
        "still_applied":           "Sí quedó hecho: {actions}.",
        "action_remember_fact":    "guardé lo que me pediste recordar",
        "action_forget_fact":      "retiré el dato que pediste olvidar",
        "action_update_profile":   "actualicé tu perfil",
        "action_request_link_code": "generé tu código de enlace",
    ...
    "en": {
        ...
        "no_confirmed_sources":    "I have no sources I can confirm about that. Want me to search again?",
        "fresh_value_withheld":    "I could not get that value now. I would rather not give you one that may have changed; shall I try again?",
        "still_applied":           "This did go through: {actions}.",
        "action_remember_fact":    "I saved what you asked me to remember",
        "action_forget_fact":      "I retired the fact you asked me to forget",
        "action_update_profile":   "I updated your profile",
        "action_request_link_code": "I issued your link code",
